...
func (*CleanupRequest) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{6} }
...
func (*CleanupResponse) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{7} }
...
func (*Range) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{8} }
...
func (*SSTMeta) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{9} }
...
func (*UploadRequest) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{10} }
...
func (*UploadResponse) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{11} }
...
func (*IngestRequest) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{12} }
...
func (*IngestResponse) Descriptor() ([]byte, []int) { return fileDescriptorImportpb, []int{13} }
...
var fileDescriptorImportpb = []byte{
	...
	,
}
