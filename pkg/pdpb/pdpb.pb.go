...
type StoreStats struct {
	...
	// Stall micros for the store.
	StallMicros uint64 `protobuf:"varint,13,opt,name=stall_micros,json=stallMicros,proto3" json:"stall_micros,omitempty"`
}
...
func (m *StoreStats) GetStallMicros() uint64 {
	if m != nil {
		return m.StallMicros
	}
	return 0
}
...
func (m *StoreStats) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StallMicros != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintPdpb(dAtA, i, uint64(m.StallMicros))
	}
	return i, nil
}
...
func (m *StoreStats) Size() (n int) {
	...
	if m.StallMicros != 0 {
		n += 1 + sovPdpb(uint64(m.StallMicros))
	}
	return n
}
...
func (m *StoreStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StallMicros", wireType)
			}
			m.StallMicros = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StallMicros |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorPdpb = []byte{
	...
	,
}
