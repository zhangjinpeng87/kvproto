...
const (
	ScheduleReason_None   ScheduleReason = 0
	ScheduleReason_Ingest ScheduleReason = 1
)

var ScheduleReason_name = map[int32]string{
	0: "None",
	1: "Ingest",
}
var ScheduleReason_value = map[string]int32{
	"None":   0,
	"Ingest": 1,
}

func (x ScheduleReason) String() string {
	return proto.EnumName(ScheduleReason_name, int32(x))
}
func (ScheduleReason) EnumDescriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{1} }
...
type ScheduleRegionRequest struct {
	Header   *RequestHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	RegionId uint64         `protobuf:"varint,2,opt,name=region_id,json=regionId,proto3" json:"region_id,omitempty"`
	// The reason to schedule this region.
	Reason ScheduleReason `protobuf:"varint,3,opt,name=reason,proto3,enum=pdpb.ScheduleReason" json:"reason,omitempty"`
	// Schedule should be done or stopped before timeout.
	// NOTE: This is just best effort, no guarantee.
	ScheduleTimeout uint32 `protobuf:"varint,4,opt,name=schedule_timeout,json=scheduleTimeout,proto3" json:"schedule_timeout,omitempty"`
	// Pin (no schedule/split/merge) the region before timeout.
	// NOTE: This is just best effort, no guarantee.
	PinRegionTimeout uint32 `protobuf:"varint,5,opt,name=pin_region_timeout,json=pinRegionTimeout,proto3" json:"pin_region_timeout,omitempty"`
}

func (m *ScheduleRegionRequest) Reset()                    { *m = ScheduleRegionRequest{} }
func (m *ScheduleRegionRequest) String() string            { return proto.CompactTextString(m) }
func (*ScheduleRegionRequest) ProtoMessage()               {}
func (*ScheduleRegionRequest) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{38} }

func (m *ScheduleRegionRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *ScheduleRegionRequest) GetRegionId() uint64 {
	if m != nil {
		return m.RegionId
	}
	return 0
...
func (m *ScheduleRegionRequest) GetReason() ScheduleReason {
	if m != nil {
		return m.Reason
	}
	return ScheduleReason_None
}

func (m *ScheduleRegionRequest) GetScheduleTimeout() uint32 {
	if m != nil {
		return m.ScheduleTimeout
	}
	return 0
}

func (m *ScheduleRegionRequest) GetPinRegionTimeout() uint32 {
	if m != nil {
		return m.PinRegionTimeout
	}
	return 0
}

type ScheduleRegionResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *ScheduleRegionResponse) Reset()                    { *m = ScheduleRegionResponse{} }
func (m *ScheduleRegionResponse) String() string            { return proto.CompactTextString(m) }
func (*ScheduleRegionResponse) ProtoMessage()               {}
func (*ScheduleRegionResponse) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{39} }

func (m *ScheduleRegionResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ScheduleRegionRequest)(nil), "pdpb.ScheduleRegionRequest")
	proto.RegisterType((*ScheduleRegionResponse)(nil), "pdpb.ScheduleRegionResponse")
	proto.RegisterEnum("pdpb.ErrorType", ErrorType_name, ErrorType_value)
	proto.RegisterEnum("pdpb.ScheduleReason", ScheduleReason_name, ScheduleReason_value)
}
...
type PDClient interface {
	...
	ScheduleRegion(ctx context.Context, in *ScheduleRegionRequest, opts ...grpc.CallOption) (*ScheduleRegionResponse, error)
}
...
func (c *pDClient) ScheduleRegion(ctx context.Context, in *ScheduleRegionRequest, opts ...grpc.CallOption) (*ScheduleRegionResponse, error) {
	out := new(ScheduleRegionResponse)
	err := grpc.Invoke(ctx, "/pdpb.PD/ScheduleRegion", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PDServer interface {
	...
	ScheduleRegion(context.Context, *ScheduleRegionRequest) (*ScheduleRegionResponse, error)
}
...
func _PD_ScheduleRegion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScheduleRegionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).ScheduleRegion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/ScheduleRegion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).ScheduleRegion(ctx, req.(*ScheduleRegionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ScheduleRegion",
			Handler:    _PD_ScheduleRegion_Handler,
		},
	},
...
func (m *ScheduleRegionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScheduleRegionRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.ScheduleTimeout != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintPdpb(dAtA, i, uint64(m.ScheduleTimeout))
	}
	if m.PinRegionTimeout != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintPdpb(dAtA, i, uint64(m.PinRegionTimeout))
	}
	return i, nil
}

func (m *ScheduleRegionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScheduleRegionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ScheduleRegionRequest) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
	...
	if m.ScheduleTimeout != 0 {
		n += 1 + sovPdpb(uint64(m.ScheduleTimeout))
	}
	if m.PinRegionTimeout != 0 {
		n += 1 + sovPdpb(uint64(m.PinRegionTimeout))
	}
	return n
}

func (m *ScheduleRegionResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *ScheduleRegionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScheduleRegionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScheduleRegionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= (ScheduleReason(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScheduleTimeout", wireType)
			}
			m.ScheduleTimeout = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ScheduleTimeout |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PinRegionTimeout", wireType)
			}
			m.PinRegionTimeout = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPdpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PinRegionTimeout |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ScheduleRegionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScheduleRegionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScheduleRegionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorPdpb = []byte{
	...
	,
}
