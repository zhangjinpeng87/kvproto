...
const (
	SuffrageState_Nonvoter SuffrageState = 0
	SuffrageState_Staging  SuffrageState = 1
	SuffrageState_Voter    SuffrageState = 2
)
...
func (SuffrageState) EnumDescriptor() ([]byte, []int) { return fileDescriptorEraftpb, []int{2} }
...
func (m *ConfState) GetServers() []*Server {
	if m != nil {
		return m.Servers
	}
	return nil
...
type Server struct {
	Node             *uint64        `protobuf:"varint,1,opt,name=node" json:"node,omitempty"`
	Suffrage         *SuffrageState `protobuf:"varint,2,opt,name=suffrage,enum=eraftpb.SuffrageState" json:"suffrage,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (*Server) Descriptor() ([]byte, []int) { return fileDescriptorEraftpb, []int{6} }

func (m *Server) GetNode() uint64 {
	if m != nil && m.Node != nil {
		return *m.Node
	}
	return 0
...
func (m *Server) GetSuffrage() SuffrageState {
	if m != nil && m.Suffrage != nil {
		return *m.Suffrage
	}
	return SuffrageState_Nonvoter
}
...
func (*ConfChange) Descriptor() ([]byte, []int) { return fileDescriptorEraftpb, []int{7} }
...
func init() {
	...
	proto.RegisterType((*Server)(nil), "eraftpb.Server")
	...
	proto.RegisterEnum("eraftpb.SuffrageState", SuffrageState_name, SuffrageState_value)
...
func (m *Server) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Node != nil {
		dAtA[i] = 0x8
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(*m.Node))
	}
	if m.Suffrage != nil {
		dAtA[i] = 0x10
		i++
		i = encodeVarintEraftpb(dAtA, i, uint64(*m.Suffrage))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Server) Size() (n int) {
	...
	_ = l
	if m.Node != nil {
		n += 1 + sovEraftpb(uint64(*m.Node))
	}
	if m.Suffrage != nil {
		n += 1 + sovEraftpb(uint64(*m.Suffrage))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
var fileDescriptorEraftpb = []byte{
	...
	,
}
