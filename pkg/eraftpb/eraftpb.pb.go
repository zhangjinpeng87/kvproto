...
type ConfState struct {
	...
	Nonvoters        []uint64 `protobuf:"varint,2,rep,name=nonvoters" json:"nonvoters,omitempty"`
	Stagings         []uint64 `protobuf:"varint,3,rep,name=stagings" json:"stagings,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *ConfState) GetNonvoters() []uint64 {
	if m != nil {
		return m.Nonvoters
	}
	return nil
...
func (m *ConfState) GetStagings() []uint64 {
	if m != nil {
		return m.Stagings
	}
	return nil
...
func (m *ConfState) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Nonvoters) > 0 {
		for _, num := range m.Nonvoters {
			dAtA[i] = 0x10
			i++
			i = encodeVarintEraftpb(dAtA, i, uint64(num))
		}
...
func (m *ConfState) Size() (n int) {
	...
	if len(m.Nonvoters) > 0 {
		for _, e := range m.Nonvoters {
			n += 1 + sovEraftpb(uint64(e))
		}
	}
	if len(m.Stagings) > 0 {
		for _, e := range m.Stagings {
			n += 1 + sovEraftpb(uint64(e))
		}
	}
	if m.XXX_unrecognized != nil {
...
func (m *ConfState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Nonvoters", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Nonvoters = append(m.Nonvoters, v)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Stagings", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Stagings = append(m.Stagings, v)
		default:
			iNdEx = preIndex
			skippy, err := skipEraftpb(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorEraftpb = []byte{
	...
	,
}
