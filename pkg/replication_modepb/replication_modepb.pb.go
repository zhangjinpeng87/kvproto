...
func (ReplicationMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_replication_modepb_160f12c257222853, []int{0}
}
...
func (DRAutoSyncState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_replication_modepb_160f12c257222853, []int{1}
}
...
func (RegionReplicationState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_replication_modepb_160f12c257222853, []int{2}
}
...
func (*StoreDRAutoSyncStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_replication_modepb_160f12c257222853, []int{3}
}
...
func init() {
	proto.RegisterFile("replication_modepb.proto", fileDescriptor_replication_modepb_160f12c257222853)
}

var fileDescriptor_replication_modepb_160f12c257222853 = []byte{
