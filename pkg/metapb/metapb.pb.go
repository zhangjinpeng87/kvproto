...
type Peer struct {
	...
	Suffrage         *eraftpb.SuffrageState `protobuf:"varint,3,opt,name=suffrage,enum=eraftpb.SuffrageState" json:"suffrage,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
func (m *Peer) GetSuffrage() eraftpb.SuffrageState {
	if m != nil && m.Suffrage != nil {
		return *m.Suffrage
	}
	return eraftpb.SuffrageState_Nonvoter
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (eraftpb.SuffrageState(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
