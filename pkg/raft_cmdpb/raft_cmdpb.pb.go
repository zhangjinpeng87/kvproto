...
type DeleteRequest struct {
	Cf               *string `protobuf:"bytes,1,opt,name=cf" json:"cf,omitempty"`
	Key              []byte  `protobuf:"bytes,2,opt,name=key" json:"key,omitempty"`
	SingleDelete     *bool   `protobuf:"varint,3,opt,name=single_delete,json=singleDelete" json:"single_delete,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *DeleteRequest) GetSingleDelete() bool {
	if m != nil && m.SingleDelete != nil {
		return *m.SingleDelete
	}
	return false
}
...
func (m *DeleteRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SingleDelete", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
