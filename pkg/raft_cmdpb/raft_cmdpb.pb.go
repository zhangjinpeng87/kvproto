...
type IngestSSTRequest struct {
	Handles          []*importpb.SSTHandle `protobuf:"bytes,1,rep,name=handles" json:"handles,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
func (m *IngestSSTRequest) GetHandles() []*importpb.SSTHandle {
	if m != nil {
		return m.Handles
	}
	return nil
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IngestSst != nil {
		...
		n8, err := m.IngestSst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Prewrite != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.Prewrite.Size()))
		n13, err := m.Prewrite.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
	...
	if m.DelteRange != nil {
		...
		n14, err := m.DelteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
	...
	if m.IngestSst != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.IngestSst.Size()))
		n15, err := m.IngestSst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *IngestSSTRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Handles = append(m.Handles, &importpb.SSTHandle{})
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
