...
type CompactLogRequest struct {
	...
	StartIndex       *uint64 `protobuf:"varint,2,opt,name=start_index" json:"start_index,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (m *CompactLogRequest) GetStartIndex() uint64 {
...
func (m *CompactLogRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.StartIndex != nil {
		data[i] = 0x10
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(*m.StartIndex))
	}
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
...
func (m *CompactLogRequest) Size() (n int) {
	...
	if m.StartIndex != nil {
		n += 1 + sovRaftCmdpb(uint64(*m.StartIndex))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
