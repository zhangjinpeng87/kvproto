...
type Context struct {
	...
	IsoLevel    IsolationLevel      `protobuf:"varint,7,opt,name=iso_level,json=isoLevel,proto3,enum=kvrpcpb.IsolationLevel" json:"iso_level,omitempty"`
}
...
func (m *Context) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IsoLevel != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.IsoLevel))
	}
	return i, nil
}
...
func (m *Context) Size() (n int) {
	...
	if m.IsoLevel != 0 {
		n += 1 + sovKvrpcpb(uint64(m.IsoLevel))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IsoLevel |= (IsolationLevel(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
