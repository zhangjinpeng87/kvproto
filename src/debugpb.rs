...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for MetaRegionsRequest {}

impl MetaRegionsRequest {
    pub fn new() -> MetaRegionsRequest {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static MetaRegionsRequest {
        static mut instance: ::protobuf::lazy::Lazy<MetaRegionsRequest> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const MetaRegionsRequest,
        };
        unsafe {
            instance.get(MetaRegionsRequest::new)
        }
    }
}

impl ::protobuf::Message for MetaRegionsRequest {
    fn is_initialized(&self) -> bool {
        true
    }
...
impl ::protobuf::MessageStatic for MetaRegionsRequest {
    fn new() -> MetaRegionsRequest {
        MetaRegionsRequest::new()
    }

    fn descriptor_static(_: ::std::option::Option<MetaRegionsRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                let fields = ::std::vec::Vec::new();
                ::protobuf::reflect::MessageDescriptor::new::<MetaRegionsRequest>(
                    "MetaRegionsRequest",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for MetaRegionsRequest {
    fn clear(&mut self) {
        self.unknown_fields.clear();
    }
}

impl ::std::fmt::Debug for MetaRegionsRequest {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MetaRegionsRequest {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
#[derive(PartialEq,Clone,Default)]
pub struct MetaRegionsResponse {
    // message fields
    pub meta_regions: ::std::vec::Vec<u64>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for MetaRegionsResponse {}

impl MetaRegionsResponse {
    pub fn new() -> MetaRegionsResponse {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static MetaRegionsResponse {
        static mut instance: ::protobuf::lazy::Lazy<MetaRegionsResponse> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const MetaRegionsResponse,
        };
        unsafe {
            instance.get(MetaRegionsResponse::new)
        }
    }

    // repeated uint64 meta_regions = 1;

    pub fn clear_meta_regions(&mut self) {
        self.meta_regions.clear();
    }

    // Param is passed by value, moved
    pub fn set_meta_regions(&mut self, v: ::std::vec::Vec<u64>) {
        self.meta_regions = v;
    }

    // Mutable pointer to the field.
    pub fn mut_meta_regions(&mut self) -> &mut ::std::vec::Vec<u64> {
        &mut self.meta_regions
    }

    // Take field
    pub fn take_meta_regions(&mut self) -> ::std::vec::Vec<u64> {
        ::std::mem::replace(&mut self.meta_regions, ::std::vec::Vec::new())
    }

    pub fn get_meta_regions(&self) -> &[u64] {
        &self.meta_regions
    }

    fn get_meta_regions_for_reflect(&self) -> &::std::vec::Vec<u64> {
        &self.meta_regions
    }

    fn mut_meta_regions_for_reflect(&mut self) -> &mut ::std::vec::Vec<u64> {
        &mut self.meta_regions
    }
}

impl ::protobuf::Message for MetaRegionsResponse {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_uint64_into(wire_type, is, &mut self.meta_regions)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.meta_regions {
...
impl ::protobuf::MessageStatic for MetaRegionsResponse {
    fn new() -> MetaRegionsResponse {
        MetaRegionsResponse::new()
    }

    fn descriptor_static(_: ::std::option::Option<MetaRegionsResponse>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_vec_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "meta_regions",
                    MetaRegionsResponse::get_meta_regions_for_reflect,
                    MetaRegionsResponse::mut_meta_regions_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<MetaRegionsResponse>(
                    "MetaRegionsResponse",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for MetaRegionsResponse {
    fn clear(&mut self) {
        self.clear_meta_regions();
        self.unknown_fields.clear();
    }
}

impl ::std::fmt::Debug for MetaRegionsResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for MetaRegionsResponse {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14\n\x12MetaRegionsRequest\"8\n\x13MetaRegionsResponse\x12!\n\x0cmeta_\
    regions\x18\x01\x20\x03(\x04R\x0bmetaRegions\"F\n\x16InjectFailPointRequ\
    ...
    tResponse\"\0\x12J\n\x0bMetaRegions\x12\x1b.debugpb.MetaRegionsRequest\
    \x1a\x1c.debugpb.MetaRegionsResponse\"\0\x12V\n\x0fInjectFailPoint\x12\
    \x1f.debugpb.InjectFailPointRequest\x1a\x20.debugpb.InjectFailPointRespo\
    nse\"\0\x12Y\n\x10RecoverFailPoint\x12\x20.debugpb.RecoverFailPointReque\
    st\x1a!.debugpb.RecoverFailPointResponse\"\0\x12S\n\x0eListFailPoints\
    \x12\x1e.debugpb.ListFailPointsRequest\x1a\x1f.debugpb.ListFailPointsRes\
    ponse\"\0B&\n\x18com.pingcap.tikv.kvproto\xe0\xe2\x1e\x01\xc8\xe2\x1e\
    \x01\xd0\xe2\x1e\x01J\xee&\n\x07\x12\x05\0\0\x9f\x01\x01\n\x08\n\x01\x0c\
    ...
    \x12\x03\x0c\x160\n\xe3\x02\n\x02\x06\0\x12\x04\x17\07\x01\x1a\xd6\x02\
    ...
    $\n\x04\x06\0\x02\x06\x12\x03.\x04H\x1a\x17\x20Get\x20all\x20meta\x20reg\
    ions.\n\n\x0c\n\x05\x06\0\x02\x06\x01\x12\x03.\x08\x13\n\x0c\n\x05\x06\0\
    \x02\x06\x02\x12\x03.\x14&\n\x0c\n\x05\x06\0\x02\x06\x03\x12\x03.1D\nl\n\
    \x04\x06\0\x02\x07\x12\x032\x04T\x1a_\x20Inject\x20a\x20fail\x20point.\
    \x20Currently,\x20it's\x20only\x20used\x20in\x20tests.\n\x20Note:\x20DO\
    \x20NOT\x20CALL\x20IT\x20IN\x20PRODUCTION.\n\n\x0c\n\x05\x06\0\x02\x07\
    \x01\x12\x032\x08\x17\n\x0c\n\x05\x06\0\x02\x07\x02\x12\x032\x18.\n\x0c\
