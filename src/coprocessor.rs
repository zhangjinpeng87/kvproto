...
pub struct Response {
    ...
    pub select_resp: ::std::vec::Vec<u8>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl Response {
    ...
    // Param is passed by value, moved
    pub fn set_select_resp(&mut self, v: ::std::vec::Vec<u8>) {
        self.select_resp = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_select_resp(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.select_resp
    }

    // Take field
    pub fn take_select_resp(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.select_resp, ::std::vec::Vec::new())
    }

    pub fn get_select_resp(&self) -> &[u8] {
        &self.select_resp
    }

    fn get_select_resp_for_reflect(&self) -> &::std::vec::Vec<u8> {
        &self.select_resp
    }

    fn mut_select_resp_for_reflect(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.select_resp
    }
}
...
impl ::protobuf::Message for Response {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.select_resp)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.select_resp.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.select_resp);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.select_resp.is_empty() {
            os.write_bytes(5, &self.select_resp)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x04\x20\x03(\x0b2\x15.coprocessor.KeyRangeR\x06ranges\"\xab\x02\n\
    ...
    ct_resp\x18\x05\x20\x01(\x0cR\nselectRespB2\xda\xde\x1f.github.com/pingc\
    ap/tipb/go-tipb.SelectResponseB&\n\x18com.pingcap.tikv.kvproto\xc8\xe2\
    \x1e\x01\xe0\xe2\x1e\x01\xd0\xe2\x1e\x01J\x8e\x0c\n\x06\x12\x04\0\0\x20\
    ...
    \x04\x02\x02\0\x08\xe7\x07\0\x12\x03\x1b\x14^\n\x10\n\t\x04\x02\x02\0\
    \x08\xe7\x07\0\x02\x12\x03\x1b\x14*\n\x11\n\n\x04\x02\x02\0\x08\xe7\x07\
    \0\x02\0\x12\x03\x1b\x14*\n\x12\n\x0b\x04\x02\x02\0\x08\xe7\x07\0\x02\0\
