...
pub struct Response {
    ...
    pub select_resp: ::protobuf::SingularPtrField<super::select::SelectResponse>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl Response {
    ...
    // .tipb.SelectResponse select_resp = 5;

    pub fn clear_select_resp(&mut self) {
        self.select_resp.clear();
    }

    pub fn has_select_resp(&self) -> bool {
        self.select_resp.is_some()
    }

    // Param is passed by value, moved
    pub fn set_select_resp(&mut self, v: super::select::SelectResponse) {
        self.select_resp = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_select_resp(&mut self) -> &mut super::select::SelectResponse {
        if self.select_resp.is_none() {
            self.select_resp.set_default();
        }
        self.select_resp.as_mut().unwrap()
    }

    // Take field
    pub fn take_select_resp(&mut self) -> super::select::SelectResponse {
        self.select_resp.take().unwrap_or_else(|| super::select::SelectResponse::new())
    }

    pub fn get_select_resp(&self) -> &super::select::SelectResponse {
        self.select_resp.as_ref().unwrap_or_else(|| super::select::SelectResponse::default_instance())
    }

    fn get_select_resp_for_reflect(&self) -> &::protobuf::SingularPtrField<super::select::SelectResponse> {
        &self.select_resp
    }

    fn mut_select_resp_for_reflect(&mut self) -> &mut ::protobuf::SingularPtrField<super::select::SelectResponse> {
        &mut self.select_resp
    }
}
...
impl ::protobuf::Message for Response {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.select_resp)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.select_resp.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static(_: ::std::option::Option<Response>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::select::SelectResponse>>(
                    "select_resp",
                    Response::get_select_resp_for_reflect,
                    Response::mut_select_resp_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pb.proto\x1a\x14gogoproto/gogo.proto\x1a\x0cselect.proto\"2\n\x08KeyRang\
    e\x12\x14\n\x05start\x18\x01\x20\x01(\x0cR\x05start\x12\x10\n\x03end\x18\
    \x02\x20\x01(\x0cR\x03end\"\x88\x01\n\x07Request\x12*\n\x07context\x18\
    \x01\x20\x01(\x0b2\x10.kvrpcpb.ContextR\x07context\x12\x0e\n\x02tp\x18\
    \x02\x20\x01(\x03R\x02tp\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\x04data\
    \x12-\n\x06ranges\x18\x04\x20\x03(\x0b2\x15.coprocessor.KeyRangeR\x06ran\
    ges\"\x8d\x02\n\x08Response\x12K\n\x04data\x18\x01\x20\x01(\x0cR\x04data\
    B7\xda\xde\x1f/github.com/pingcap/tipb/sharedbytes.SharedBytes\xc8\xde\
    \x1f\0\x121\n\x0cregion_error\x18\x02\x20\x01(\x0b2\x0e.errorpb.ErrorR\
    \x0bregionError\x12)\n\x06locked\x18\x03\x20\x01(\x0b2\x11.kvrpcpb.LockI\
    nfoR\x06locked\x12\x1f\n\x0bother_error\x18\x04\x20\x01(\tR\notherError\
    \x125\n\x0bselect_resp\x18\x05\x20\x01(\x0b2\x14.tipb.SelectResponseR\ns\
    electRespB&\n\x18com.pingcap.tikv.kvproto\xd0\xe2\x1e\x01\xc8\xe2\x1e\
    \x01\xe0\xe2\x1e\x01J\xaf\x0b\n\x06\x12\x04\0\0!\x01\n\x08\n\x01\x0c\x12\
    \x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x01\x08\x13\n\t\n\x02\x03\0\x12\x03\
