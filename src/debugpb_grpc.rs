...
impl DebugClient {
    ...
    pub fn get_metrics_async_opt(&self, req: super::debugpb::GetMetricsRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::debugpb::GetMetricsResponse> {
        self.client.unary_call_async(&METHOD_DEBUG_GET_METRICS, req, opt)
    }

    pub fn get_metrics_async(&self, req: super::debugpb::GetMetricsRequest) -> ::grpcio::ClientUnaryReceiver<super::debugpb::GetMetricsResponse> {
    ...
    pub fn check_region_consistency_async_opt(&self, req: super::debugpb::RegionConsistencyCheckRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::debugpb::RegionConsistencyCheckResponse> {
        self.client.unary_call_async(&METHOD_DEBUG_CHECK_REGION_CONSISTENCY, req, opt)
    }

    pub fn check_region_consistency_async(&self, req: super::debugpb::RegionConsistencyCheckRequest) -> ::grpcio::ClientUnaryReceiver<super::debugpb::RegionConsistencyCheckResponse> {
    ...
    pub fn modify_tikv_config_async_opt(&self, req: super::debugpb::ModifyTikvConfigRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::debugpb::ModifyTikvConfigResponse> {
        self.client.unary_call_async(&METHOD_DEBUG_MODIFY_TIKV_CONFIG, req, opt)
    }

    pub fn modify_tikv_config_async(&self, req: super::debugpb::ModifyTikvConfigRequest) -> ::grpcio::ClientUnaryReceiver<super::debugpb::ModifyTikvConfigResponse> {
