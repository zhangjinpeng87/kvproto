...
impl PdClient {
    ...
    pub fn get_all_stores_async_opt(&self, req: super::pdpb::GetAllStoresRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::pdpb::GetAllStoresResponse> {
        self.client.unary_call_async(&METHOD_PD_GET_ALL_STORES, req, opt)
    }

    pub fn get_all_stores_async(&self, req: super::pdpb::GetAllStoresRequest) -> ::grpcio::ClientUnaryReceiver<super::pdpb::GetAllStoresResponse> {
