...
const METHOD_PD_TRANSFER_LEADER: ::grpcio::Method<super::pdpb::TransferLeaderRequest, super::pdpb::TransferLeaderResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/pdpb.PD/TransferLeader",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl PdClient {
    ...
    pub fn transfer_leader_opt(&self, req: super::pdpb::TransferLeaderRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::pdpb::TransferLeaderResponse> {
        self.client.unary_call(&METHOD_PD_TRANSFER_LEADER, req, opt)
    }

    pub fn transfer_leader(&self, req: super::pdpb::TransferLeaderRequest) -> ::grpcio::Result<super::pdpb::TransferLeaderResponse> {
        self.transfer_leader_opt(req, ::grpcio::CallOption::default())
    }

    pub fn transfer_leader_async_opt(&self, req: super::pdpb::TransferLeaderRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::pdpb::TransferLeaderResponse> {
        self.client.unary_call_async(&METHOD_PD_TRANSFER_LEADER, req, opt)
    }

    pub fn transfer_leader_async(&self, req: super::pdpb::TransferLeaderRequest) -> ::grpcio::ClientUnaryReceiver<super::pdpb::TransferLeaderResponse> {
        self.transfer_leader_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait Pd {
    ...
    fn transfer_leader(&self, ctx: ::grpcio::RpcContext, req: super::pdpb::TransferLeaderRequest, sink: ::grpcio::UnarySink<super::pdpb::TransferLeaderResponse>);
}
...
pub fn create_pd<S: Pd + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_PD_TRANSFER_LEADER, move |ctx, req, resp| {
        instance.transfer_leader(ctx, req, resp)
    });
    builder.build()
}
