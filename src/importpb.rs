...
impl ::protobuf::Message for SSTInfo {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.cf_name.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.cf_name);
        }
        if self.region_id != 0 {
            my_size += ::protobuf::rt::value_size(5, self.region_id, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.cf_name.is_empty() {
            os.write_string(4, &self.cf_name)?;
        }
        if self.region_id != 0 {
            os.write_uint64(5, self.region_id)?;
        }
        if let Some(ref v) = self.region_epoch.as_ref() {
