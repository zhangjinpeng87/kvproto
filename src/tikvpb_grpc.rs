...
impl TikvClient {
    ...
    pub fn kv_unsafe_cleanup_range_async_opt(&self, req: super::kvrpcpb::UnsafeCleanupRangeRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::kvrpcpb::UnsafeCleanupRangeResponse> {
        self.client.unary_call_async(&METHOD_TIKV_KV_UNSAFE_CLEANUP_RANGE, req, opt)
    }

    pub fn kv_unsafe_cleanup_range_async(&self, req: super::kvrpcpb::UnsafeCleanupRangeRequest) -> ::grpcio::ClientUnaryReceiver<super::kvrpcpb::UnsafeCleanupRangeResponse> {
    ...
    pub fn raw_delete_range_async_opt(&self, req: super::kvrpcpb::RawDeleteRangeRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::kvrpcpb::RawDeleteRangeResponse> {
        self.client.unary_call_async(&METHOD_TIKV_RAW_DELETE_RANGE, req, opt)
    }

    pub fn raw_delete_range_async(&self, req: super::kvrpcpb::RawDeleteRangeRequest) -> ::grpcio::ClientUnaryReceiver<super::kvrpcpb::RawDeleteRangeResponse> {
