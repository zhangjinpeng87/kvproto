...
pub struct IngestSSTRequest {
    // message fields
    handles: ::protobuf::RepeatedField<super::importpb::SSTHandle>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl IngestSSTRequest {
    ...
    // repeated .importpb.SSTHandle handles = 1;
    ...
    // Param is passed by value, moved
    pub fn set_handles(&mut self, v: ::protobuf::RepeatedField<super::importpb::SSTHandle>) {
        self.handles = v;
    }

    // Mutable pointer to the field.
    pub fn mut_handles(&mut self) -> &mut ::protobuf::RepeatedField<super::importpb::SSTHandle> {
        &mut self.handles
    }

    // Take field
    pub fn take_handles(&mut self) -> ::protobuf::RepeatedField<super::importpb::SSTHandle> {
        ::std::mem::replace(&mut self.handles, ::protobuf::RepeatedField::new())
    }

    pub fn get_handles(&self) -> &[super::importpb::SSTHandle] {
        &self.handles
    }

    fn get_handles_for_reflect(&self) -> &::protobuf::RepeatedField<super::importpb::SSTHandle> {
        &self.handles
    }

    fn mut_handles_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<super::importpb::SSTHandle> {
        &mut self.handles
    }
}
...
impl ::protobuf::MessageStatic for IngestSSTRequest {
    ...
    fn descriptor_static(_: ::std::option::Option<IngestSSTRequest>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::importpb::SSTHandle>>(
                    "handles",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\x0cR\x04lock\"\x12\n\x10PrewriteResponse\"A\n\x10IngestSSTRequ\
    est\x12-\n\x07handles\x18\x01\x20\x03(\x0b2\x13.importpb.SSTHandleR\x07h\
    andles\"\x13\n\x11IngestSSTResponse\"\xa6\x03\n\x07Request\x12.\n\x08cmd\
    _type\x18\x01\x20\x01(\x0e2\x13.raft_cmdpb.CmdTypeR\x07cmdType\x12(\n\
    ...
    \x12\x03C\r\x1f\n\x0c\n\x05\x04\x0c\x02\0\x01\x12\x03C\x20'\n\x0c\n\x05\
